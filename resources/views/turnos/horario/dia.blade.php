...
@endif
{!! Form::open(['route' => 'horario.agregardia', 'method'=>'post']) !!}
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col md-4">                
        ...
        <div class="row">
            ...
            <div class="col md-3">                
                ...
                <input type="text" id="intervalo" name="intervalo" class="form-control" value="{{ old('intervalo')}}"/>
                @error('intervalo')
                    <strong style="color:red">*{{$message}}</strong>
                @enderror
            </div>
